      ...
      try {
        if ('key' in msg) {
          ...
          if ('keyHolder' in socket) {
            ...
            try {
              for (var _iterator3 = socket.keyHolder.connectingPeers[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
